...
import { ChatSuggestions } from "@/components/chat/composer/suggestions"
import { ChatterSuggestions } from "@/components/chat/composer/chatter-suggestions"
import { CommandSuggestions } from "@/components/chat/composer/command-suggestions"
import { ComposerNoticeBanner } from "@/components/chat/composer/notice-banner"
import { ChatModesMenu } from "@/components/chat/panels/modes-panel"
import { EmotePicker } from "@/components/chat/composer/emote-picker"
import { ChatReplyThreadTray } from "@/components/chat/panels/reply-thread-tray"
...
import { buildReplyThread } from "@/lib/chat/threads/reply-threads"
import { CHAT_RATE_LIMIT_MESSAGES } from "@/lib/chat/send/send"
import {
...
import type { TwitchChatReply } from "@/lib/twitch/chat/chat"
import {
  BLOCKED_USER_DISPLAY_NAME,
  maskReplyForBlockedUser,
} from "@/lib/twitch/channel/blocked-users"
...
} from "@/lib/chat/emotes/completion"
import {
...
} from "@/lib/chat/chatters/completion"
import {
...
} from "@/lib/chat/commands/completion"
...
function ChatComposerInner({
  ...
  const handleSendResult = React.useCallback(
    (
      result: import("@/lib/chat/send/send").ChatSendResult,
      composerMessage: string,
      options: {
        sentText?: string
        isAction?: boolean
